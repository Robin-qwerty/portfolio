...
<div class="navbar sticky" id="menulist">
  ...
  <a href="<?php if(isset($page) && $page != 'home'){echo'index.php?page=';} else {echo'#';}?>home" class="robin"><h1 style="margin: 0;">Robin Hollaar</h1></a>
  <div id="navbar_left">
    ...
    <a id="navlink" href="<?php if(isset($page) && $page != 'home'){echo'index.php?page=';} else {echo'#';}?>werk-school">
      <b data-lang="nl">werk/school/stage</b>
      <b data-lang="en">work/school/internship</b>
    </a>
    <a id="navlink" href="<?php if(isset($page) && $page != 'home'){echo'index.php?page=';} else {echo'#';}?>hobbys">
      <b data-lang="nl">Hobby's</b>
      <b data-lang="en">Hobbies</b>
    </a>
