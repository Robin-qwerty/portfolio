<?php
  ...
  try {
    if ($_POST['naam'] == '' || $_POST['achternaam'] == '' || $_POST['woonplaats'] == '' || $_POST['straat'] == '' || $_POST['huisnummer'] == '' || $_POST['postcode'] == '' || $_POST['geboortendatum'] == '' || $_POST['email'] == '' || $_POST['psw'] == '') {
      ...
      $sql = "INSERT INTO users (roll, naam, tussenvoegsel, achternaam, woonplaats, straat, huisnummer, postcode, geboortendatum, email, password)
      VALUES (:roll, :naam, :tussenvoegsel, :achternaam, :woonplaats, :straat, :huisnummer, :postcode, :geboortendatum, :username, :password)";
      ...
      $sth->bindParam(':geboortendatum', $_POST['geboortendatum']);
      $sth->execute();
